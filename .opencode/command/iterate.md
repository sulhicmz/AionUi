...
**Objective:** Add ONE high-value missing feature.

1. Review `docs/blueprint.md` and `docs/roadmap.md`.
2. Identify a meaningful functional gap.
3. Define:
   - User story
   - Acceptance criteria
